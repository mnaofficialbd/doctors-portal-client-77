...
const AddDoctor = () => {
    ...
    const { data: services, isLoading } = useQuery('services', () => { fetch('https://mna-doctors-portal.herokuapp.com/service').then(res => res.json()) })
        ...
        fetch(url, {
            ...
            .then(result => {
                if (result.success) {
                    ...
                    fetch('https://mna-doctors-portal.herokuapp.com/doctor',{
                        method:'POST',
                        headers:{
